...
class RAGSystem:
    def __init__(self, knowledge_content: str, index_name: str, namespace: str, 
                 model: str = "gpt-4.1", description: str = "Knowledge base"):
        """
    ...
    def _load_documents(self):
        ...
        try:
            ...
            print(f"� Loaded {len(doc_splits)} {self.description.lower()} document chunks")
    ...
    def _setup_retrieval_chain(self):
        ...
        llm = ChatOpenAI(temperature=0.0, model=self.model, name=f"Retriever-{self.description}")
...
def get_rag_system(knowledge_content: str, index_name: str, namespace: str, 
                   model: str = "gpt-4.1", description: str = "Knowledge base") -> RAGSystem:
    """
